...
#define VPP_FLOW_PRINT(...)  VPPAPI_DBG_INFO(__VA_ARGS__)
...
#define VPP_FRC_SCL_LAY_MAX      6 /* Max amoung all the scalers */
#elif (BERLIN_CHIP_VERSION == BERLIN_BG5_CT)
#define VPP_FRC_SCL_MAIN_LAY_MAX 4 /* Main and VIP SCL */
#define VPP_FRC_SCL_GFX_LAY_MAX  2 /* PIP and OSD */
#define VPP_FRC_SCL_LAY_MAX      4 /* Max amoung all the scalers */
#else
...
#define CAPTURE_BUFFER_SIZE (3840*2160*4) //4K ARGB888, to allow 4K Android UI capture
...
//HDMI IS ENABLED by macro 'CONFIG_AMP_HDMI_SERVICE'
...
/*Enabling macro would disable only HDMI related interface otherwise disable all interface to TA*/
#define VPP_ENABLE_VPP_TA_IN_QUIESCENT_MODE
...
#define VDB_print(...)  VPPAPI_DBG_INFO(__VA_ARGS__)
...
#define PRINT_WIN(planeID, win)      \
    VPPAPI_DBG_INFO(VPP_DEBUG_CROP_PREFIX " %s : plane [%d], x[%d], y[%d], width[%d], height[%d] \n",__FUNCTION__, planeID, win->x, win->y, win->width, win->height);
#define PRINT_WIN1(win)      \
    VPPAPI_DBG_INFO(VPP_DEBUG_CROP_PREFIX " %s : Win [%s], x[%d], y[%d], width[%d], height[%d] \n",__FUNCTION__, #win, (win)->x, (win)->y, (win)->width, (win)->height);
#else
...
typedef enum {
    ...
    MV_VPP_ENOTIMPL       = 0x0001,   /**< Function/feature not implementated. */
    MV_VPP_EBADPARAM      = 0x0002,   /**< Function parameter error. */
    MV_VPP_ENOMEM         = 0x0003,   /**< Not enough memory. */
    MV_VPP_ENOSHM         = 0x0004,   /**< Not enough share memory. */
    MV_VPP_ETIMEOUT       = 0x0005,   /**< Operation timeout. */
    MV_VPP_EERRSYSCALL    = 0x0006,   /**< Syscall error. */
    MV_VPP_EIOFAIL        = 0x0007,   /**< Perepheral IO fail. */
    MV_VPP_EEVENTFULL     = 0x0008,   /**< Event queue full. */
    MV_VPP_EHARDWAREBUSY  = 0x0009,   /**< Hardware busy. */
    MV_VPP_EHWFAIL        = 0x000A,   /**< Hardware fail. */
    MV_VPP_EOSALFAIL      = 0x000B,   /**< OSAL fail. */
    MV_VPP_ENOSWRSC       = 0x000C,   /**< Not enough software resource. */
    MV_VPP_ENOHWRSC       = 0x000D,   /**< Not enough hardware resource. */
    MV_VPP_ESWSTATEWRONG  = 0x000E,   /**< Don't permit in current software state. */
    MV_VPP_EHWSTATEWRONG  = 0x000F,   /**< Don't permit in current hardware state. */
    MV_VPP_ERCPERROR      = 0x0010,   /**< RPC error. */
    MV_VPP_ESWMODEWRONG   = 0x0011,   /**< Software mode wrong. */
    MV_VPP_EHWMODEWRONG   = 0x0012,   /**< Hardware mode wrong. */
    MV_VPP_ECONNCLEARED   = 0x0013,   /**< Connection has been cleared error. */
    MV_VPP_ERANGEPARAM    = 0x0014,   /**< Parameter is out of range. */
    MV_VPP_ECANCELLED     = 0x0015,   /**< Operation is cancelled. */
    MV_VPP_EBDERROR       = 0x0016,   /**< BD data error. */

    MV_VPP_EPRIVATE_BASE  = 0x1000,   /**< The module private error value base. */
    MV_VPP_ENODEV         = 0x1001,   /**< No device. */
    MV_VPP_EBADCALL       = 0x1002,   /**< channel not connected to DV */
    MV_VPP_EUNSUPPORT     = 0x1003,   /**< plane not connected in configuration*/
    MV_VPP_EUNCONFIG      = 0x1004,   /**< VPP not configured */
    MV_VPP_ECMDQFULL      = 0x1005,   /**< Command Queue is full */
    MV_VPP_EFRAMEQFULL    = 0x1006,   /**< Frame Queue is full */
    MV_VPP_EBCMBUFFULL    = 0x1007,   /**< BCM Buffer is full */
    MV_VPP_EVBIBUFFULL    = 0x1008,   /**< VBI Buffer is full */
    MV_VPP_ENOSINKCNCTED  = 0x1009,   /**< Not connected to Sink device*/
    MV_VPP_ENOHDCPENABLED = 0x100A,   /**< HDCP not enabled */
    MV_VPP_EHDCPNOOP      = 0x100B,   /**< No operation require, already set */
}MV_VPP_ERROR;
...
/* definition of DEINT parameter cmd */
typedef enum {
    DEINT_CMD_INVALID = -1,
...
#define IS_GFX_SRC_FORMAT(src_fmt) ((src_fmt == SRCFMT_XRGB32) || (src_fmt == SRCFMT_ARGB32_PM) || (src_fmt == SRCFMT_ARGB32) || (src_fmt == SRCFMT_IPT444) \
     ...
     || (src_fmt == SRCFMT_ARBG2101010) || (src_fmt == SRCFMT_RGB888))

#define IS_GFX_AMP_FORMAT(src_fmt) ((src_fmt == AMP_DISP_SRCFMT_XRGB32) || (src_fmt == AMP_DISP_SRCFMT_ARGB32_PM) || (src_fmt == AMP_DISP_SRCFMT_ARGB32)\
               || (src_fmt == AMP_DISP_SRCFMT_IPT444) || (src_fmt == AMP_DISP_SRCFMT_ARGB1555) || (src_fmt == AMP_DISP_SRCFMT_ARGB4444)\
              || (src_fmt == AMP_DISP_SRCFMT_RGB565) || (src_fmt == AMP_DISP_SRCFMT_ARBG2101010))
#define VPP_IS_SINGLE_CLIENT_SRC_FMT(srcfmt) \
              (IS_GFX_SRC_FORMAT(srcfmt) || SRCFMT_YUV422 == srcfmt)

/* Minimum scaling window supported by VPP */
...
#define IS_GFX_AMP_FORMAT(src_fmt) ((src_fmt == AMP_DISP_SRCFMT_XRGB32) || (src_fmt == AMP_DISP_SRCFMT_ARGB32_PM) || (src_fmt == AMP_DISP_SRCFMT_ARGB32) \
               || (src_fmt == AMP_DISP_SRCFMT_IPT444))

/* Minimum scaling window supported by VPP */
#define VPP_WIN_MIN_INPUT_WIDTH     10
#define VPP_WIN_MIN_INPUT_HEIGHT    10
#define VPP_WIN_MIN_OUTPUT_WIDTH    10
#define VPP_WIN_MIN_OUTPUT_HEIGHT   10
#endif

#define VPP_WIN_MIN_SCALE_RATIO     8

#if (BERLIN_CHIP_VERSION > BERLIN_VS680)
#define VPP_ISNOT_VIDEO_DV_PLANE(planeID) ((planeID != PLANE_MAIN) && (planeID != PLANE_PIP))
#else
#define VPP_ISNOT_VIDEO_DV_PLANE(planeID) ((planeID != PLANE_MAIN))
#endif

#define IS_DOVI_SRC_FMT(src_fmt) ((src_fmt == SRCFMT_YUV420SP) || \
        (src_fmt == SRCFMT_YUV420SP_TILED_MODE0) || \
        (src_fmt == SRCFMT_YUV420SP_TILED_MODE1) || \
        (src_fmt == SRCFMT_YUV420SP_TILED_V4H8))
...
/*Bit mask for dolby vision configuration for low latency. It shall be (1) for dolbyvision low latency stream*/
#define VPP_DOLBY_VISION_LL  (1 << 3)
...
typedef enum {
    ...
    RES_VESA_800x600P60        = 111,
    RES_VESA_1280x768P60       = 112,
    RES_VESA_1360x768P60       = 113,
    RES_VESA_1024x768P60       = 114,
    RES_CUSTOM_1280x800P60     = 115,
    RES_VESA_1280x1024P60      = 116,
    RES_VESA_1440X900P60       = 117,
    RES_CVT_1400x1050P60       = 118,
    RES_VESA_1680x1050P60      = 119,
    RES_VESA_1600x1200P60      = 120,
    RES_CUSTOM_1366X768P60     = 121,
...
typedef enum VPP_UNIQUE_FORMAT_ID
{
    ...
    VPP_UNIQUE_FORMAT_ID_24BIT_YUV444       =   18,
    VPP_UNIQUE_FORMAT_ID_30BIT_YUV444       =   19,
    VPP_UNIQUE_FORMAT_ID_RGB888             =   20,
    VPP_UNIQUE_FORMAT_ID_24BIT_422_YC  = 21,
...
typedef enum VPP_NGPTV_CMD_t
{
    ...
    VPP_NGPTV_CONFIG_PAYLOAD_TIME_CODE_IN,
    VPP_NGPTV_CONFIG_PAYLOAD_OPERATOR_ID_IN,
    VPP_NGPTV_CONFIG_PAYLOAD_DEVICE_ID_IN,
    VPP_NGPTV_CONFIG_UPDATE_24BIT_MODE_IN,
    VPP_NGPTV_CONFIG_UPDATE_DEBUG_EN_IN,
...
typedef enum VPP_HDMI_HDCP_VERSION_T
{
    ...
    VPP_HDMI_HDCP_VER_HDCP_2_3 = 3,
    VPP_HDMI_HDCP_VER_AUTO = 4,
}VPP_HDMI_HDCP_VERSION;

typedef enum VPP_HDMI_HDCP_MODE_T
{
    VPP_HDMI_HDCP_MODE_TXRX = 0,
    VPP_HDMI_HDCP_MODE_RPTR = 1,
}VPP_HDMI_HDCP_MODE;

/* definition of VOP2 input mode */
typedef enum {
    VOUT_DISP_SINGLE_MODE_PRI  = 0,/**< Primary overlay output on Primary Display */
    VOUT_DISP_SINGLE_MODE_SEC  = 1,/**< Primary overlay output on Secondary Display */
    VOUT_DISP_DUAL_MODE_PIP    = 2,/**< Secondary output with PIP plane. */
    VOUT_DISP_DUAL_MODE_GFX0    = 3,/**< Secondary output with GFX1 plane. */
    VOUT_DISP_DUAL_MODE_GFX1    = 4,/**< Secondary output with GFX2 plane. */
    VOUT_DISP_MODE_MAX       = 5/**< Output type Max */
}VOUT_DISP_MODE;

typedef enum
{
    VPP_OUTFORMAT_DOVI      = 0,     // same as FORMAT_DOVI & OUTPUT_MODE_DOVI
    VPP_OUTFORMAT_HDR       = 1,    // same as FORMAT_HDR10 & OUTPUT_MODE_HDR
    VPP_OUTFORMAT_SDR       = 2,      // same as FORMAT_SDR & OUTPUT_MODE_SDR
    VPP_OUTFORMAT_SDR2020   = 3,
    VPP_OUTFORMAT_HLG       = 4,
    VPP_OUTFORMAT_HDR10PLUS = 5,
    VPP_OUTFORMAT_MAX       = 6,
}VPP_OUTFORMAT;
...
typedef struct VPP_COLORTEMP_T
{
    float Rgain;
    float Ggain;
    float Bgain;
...
typedef struct VPP_CMU_EE_DEFAULT_MODE_STRUCT_T {
    UINT32                      ui32Ctrlparam;               /**<  For control param */
} VPP_CMU_EE_DEFAULT_MODE_STRUCT;

typedef struct VPP_CMU_EE_SOFT_BYPASS_MODE_STRUCT_T {
    UINT32                      ui32Ctrlparam;               /**<  For control param */
} VPP_CMU_EE_SOFT_BYPASS_MODE_STRUCT;

typedef struct VPP_CMU_EE_ONLY_UPS_ENABLED_STRUCT_T {
    UINT32                      ui32Ctrlparam;                /**<  For control param */
} VPP_CMU_EE_ONLY_UPS_ENABLED_STRUCT;

typedef struct VPP_CMU_EE_ONLY_UPS_WITH_RINGING_ADAPT_STRUCT_T {
    UINT32                      ui32Ctrlparam;                /**<  For control param */
} VPP_CMU_EE_ONLY_UPS_WITH_RINGING_ADAPT_STRUCT;

typedef struct VPP_CMU_EE_OLD_LTI_CTI_WITH_ALL_STRUCT_T {
    UINT32                      ui32Ctrlparam;                /**<  For control param */
} VPP_CMU_EE_OLD_LTI_CTI_WITH_ALL_STRUCT;

typedef struct VPP_CMU_EE_NEW_LTI_CTI_WITH_WITHOUT_DETAILER_STRUCT_T {
    UINT32                      ui32Ctrlparam;                /**<  For control param */
} VPP_CMU_EE_NEW_LTI_CTI_WITH_WITHOUT_DETAILER_STRUCT;

typedef struct VPP_CMU_EE_NEW_LTI_CTI_WITH_ALL_STRUCT_T {
    UINT32                      ui32Ctrlparam;                /**<  For control param */
} VPP_CMU_EE_NEW_LTI_CTI_WITH_ALL_STRUCT;

typedef struct VPP_CMU_EE_NEW_LTI_CTI_WITH_CUSTOM_GAIN_CONTROL_STRUCT_T {
    UINT8                       u8Ltigain;               /**<  Luma Transient Improvement gain */
    UINT8                       u8Ctigain;               /**<  Chroma Transient Improvement gain */
    UINT16                      ui16Rsrvd;               /**<  For later use */
} VPP_CMU_EE_NEW_LTI_CTI_WITH_CUSTOM_GAIN_CONTROL_STRUCT;

typedef union VPP_CMU_EE_CTRL_PARAM_T {
    VPP_CMU_EE_DEFAULT_MODE_STRUCT                          stVppCmuDefaultCtrlParam;
    VPP_CMU_EE_SOFT_BYPASS_MODE_STRUCT                      stVppCmuSoftBypassCtrlParam;
    VPP_CMU_EE_ONLY_UPS_ENABLED_STRUCT                      stVppCmuUpsEnParam;
    VPP_CMU_EE_ONLY_UPS_WITH_RINGING_ADAPT_STRUCT           stVppCmuUpsEnRingParam;
    VPP_CMU_EE_OLD_LTI_CTI_WITH_ALL_STRUCT                  stVppCmuOldLtiCtiCtrlParam;
    VPP_CMU_EE_NEW_LTI_CTI_WITH_WITHOUT_DETAILER_STRUCT     stVppCmuNewLtiCtiNoDetailerCtrlParam;
    VPP_CMU_EE_NEW_LTI_CTI_WITH_ALL_STRUCT                  stVppCmuNewLtiCtiCtrlParam;
    VPP_CMU_EE_NEW_LTI_CTI_WITH_CUSTOM_GAIN_CONTROL_STRUCT  stVppCmuLtiCtiCustomCtrlParam;
}VPP_CMU_EE_CTRL_PARAM;  // union for all modes parameters

/*definition of CMU EE mode*/
typedef enum {
    VPP_CMU_EE_DEFAULT_MODE = 0,
    VPP_CMU_EE_SOFT_BYPASS_MODE,
    VPP_CMU_EE_ONLY_UPS_ENABLED,
    VPP_CMU_EE_ONLY_UPS_WITH_RINGING_ADAPT,
    VPP_CMU_EE_OLD_LTI_CTI_WITH_ALL,
    VPP_CMU_EE_NEW_LTI_CTI_WITH_WITHOUT_DETAILER,
    VPP_CMU_EE_NEW_LTI_CTI_WITH_ALL,
    VPP_CMU_EE_NEW_LTI_CTI_WITH_CUSTOM_GAIN_CONTROL,
    VPP_CMU_EE_MAX_MODE
}ENUM_VPP_CMU_EE_MODE;
...
// Type of Channel
typedef enum tagVPP_CHANNEL_TYPE
{
    VPP_FIRST_CHANNEL = 0,
    VPP_MAIN = 0,
    VPP_PIP,
...
#define VPP_PICTURE_CTRL_VAL_MIN    0
#define VPP_PICTURE_CTRL_VAL_MAX    500
#define VPP_CMU_CTRL_VAL_MIN        0
#define VPP_CMU_CTRL_VAL_MAX        1000
#define VPP_CMU_CLR_TEMPERATUE_MIN  2500
#define VPP_CMU_CLR_TEMPERATUE_MAX  8000

#define IS_VALID_PICTURE_CTRL_VAL(CtrlVal) \
                ((CtrlVal < VPP_PICTURE_CTRL_VAL_MIN) || (CtrlVal > VPP_PICTURE_CTRL_VAL_MAX))

#define IS_VPP_VALID_CMU_CTRL_TEMP_VAL(CtrlSel, CtrlVal) \
        ((CtrlSel == PICTURE_CTRL_COLORTEMPERATURE) && IS_VPP_VALID_CMU_TEMP(CtrlVal))
#define IS_VPP_VALID_CMU_TEMP(CtrlVal) \
                ((CtrlVal < VPP_CMU_CLR_TEMPERATUE_MIN) || (CtrlVal > VPP_CMU_CLR_TEMPERATUE_MAX))

#define IS_VPP_VALID_CMU_CTRL_VAL(CtrlVal) \
                ((CtrlVal < VPP_CMU_CTRL_VAL_MIN) || (CtrlVal > VPP_CMU_CTRL_VAL_MAX))
...
#define VPP_OCSC_CLR_TEMP_GAIN_MIN 0.0
#define VPP_OCSC_CLR_TEMP_GAIN_MAX 1.5
/* Default OCSC color Temperature is 6500Kelvin */
#define VPP_OCSC_CLR_TEMP_MIN 1000
#define VPP_OCSC_CLR_TEMP_MAX 40000

//Need to support at least 7 decimal place accuracy for gain
#define VPP_OCSC_GAIN_MULTIPLIER    10000000
#define VPP_OCSC_GAIN_FLOAT2INT(gain)  (gain*VPP_OCSC_GAIN_MULTIPLIER)
#define VPP_OCSC_GAIN_INT2FLOAT(gain)  (gain/(VPP_OCSC_GAIN_MULTIPLIER*1.0))

#define VPP_DEFAULT_BRIGHTNESS      0.0
#define VPP_DEFAULT_CONTRAST        1.0
#define VPP_DEFAULT_HUE             0.0
#define VPP_DEFAULT_SATURATION      1.0

#define VPP_DEFAULT_RGAIN           1.0
#define VPP_DEFAULT_GGAIN           1.0
#define VPP_DEFAULT_BGAIN           1.0


#define IS_VPP_VALID_OCSC_CLR_TEMP_GAIN(gain) \
                        ((gain< VPP_OCSC_CLR_TEMP_GAIN_MIN) || (gain> VPP_OCSC_CLR_TEMP_GAIN_MAX))
#define IS_VPP_VALID_OCSC_CLR_TEMP(temp) \
                        ((temp < VPP_OCSC_CLR_TEMP_MIN) || (temp > VPP_OCSC_CLR_TEMP_MAX))
...
typedef enum tag_VPP_GAMMA_FORMAT
{
    VPP_GAMMA_FORMAT_RGB  = 0,
    VPP_GAMMA_FORMAT_YUV,
    VPP_GAMMA_FORMAT_MAX
} VPP_GAMMA_FORMAT;

typedef struct tag_GammaLutStrcut {
    UINT16 ui16RData;
    UINT16 ui16GData;
    UINT16 ui16BData;
}VPP_GAMMA_LUT_STRUCT;

typedef struct tag_GammaLutInfo {
    ENUM_GAMMA_MODE GammaCurrentMode;
    VPP_GAMMA_FORMAT enGammaFmt;
    VPP_GAMMA_LUT_STRUCT *pstgammaLut;
}VPP_GAMMA_LUT_INFO;

#define VPP_MAIN_GAMMA_TABLE_INDEX_END      (1024)
#define GAMMA_LUT_LENGTH                    (VPP_MAIN_GAMMA_TABLE_INDEX_END + 1)
#define GAMMA_LUT_SIZE                      (GAMMA_LUT_LENGTH * sizeof(VPP_GAMMA_LUT_STRUCT))
...
{
    ENUM_TYPE     noOfresID;     /* ENUM_CPCB_TG_RES */
...
typedef struct vpp_config_params {
        ...
        UINT32 disp2_res_id;
        UINT32 disp1_bpp;
        UINT32 disp1_outformat;
        UINT32 disp2_bpp;
        UINT32 disp2_outformat;
        ARCH_PTR_TYPE data;
...
struct berlin_fb_priv {
	UINT8 bpix;
	UINT32 channel_id;
	struct vpp_config_params vpp_config_param;
...
typedef struct VPP_INIT_PARM_T{
    ...
    //Internal memory manager related parameters
...
#define STRNGTH_THRESHOLD_MAX 48
...
typedef struct VPP_MIPI_DISPLAY_CONFIG_T
{
    UINT8 panelID;
    UINT8 panelResID;
...
typedef enum
{
    ...
    DISPLAY_PANELID_PANDA_1920x1080 = 3,
    DISPLAY_PANELID_HAIER_800x1280 = 4, /*ILI9881C based HAIER panel*/
    DISPLAY_PANELID_CUSTOM = 5,
    DISPLAY_PANELID_BOE_800x1280_T1 = 6, /*ILI9881C based BOE panel*/
    DISPLAY_PANELID_MAX
}VPP_PANEL_ID;
...
typedef struct VPP_DISP_OUT_PARAMS_T {
  ...
  UINT32 uiColorFmt;
  INT32 iPixelRepeat;
  UINT32 uiDisplayMode; /*Refer VOUT_DISP_MODE for details*/
} VPP_DISP_OUT_PARAMS;

typedef struct VPP_HDR_CONFIG_PARAM_T {
    UINT8 u8ConfigEn;
    UINT8 u8AutoModeType;
    UINT32 uiSwitchingDelay[VPP_OUTFORMAT_MAX];
    UINT32 uiModuleSelect;
} VPP_HDR_CONFIG_PARAM;

typedef struct _HDMI_CONFIG {
    UINT8 isUpdated;
    UINT8 sinkBasedContentType;
    UINT8 mutePlaneOnHdcpFailure;
    UINT8 enableRxsenseCheck;
    UINT8 restrictUhdInHdcp14;
    UINT8 enableDynFPSSwitch;
    UINT8 hdcpFallbackDwnstrm1_4;
    UINT8 hdcpFallbackOn2xAuthFailure;
    UINT8 errNotifRetryCnt1x;
    UINT8 errNotifRetryCnt2x;
} HDMI_CONFIG;

typedef struct VPP_INTR_INFO_T {
    ENUM_CPCB_ID uiCpcbID;
...
#define VPP_SETCLKSIGNATURE_SIZE     ((2 * VPP_CLKGATE_SIG_MAX_WORDS) + 1) * (sizeof(UINT32))
#define VPP_SETFORMAT_SIZE           sizeof(VPP_DISP_OUT_PARAMS) + sizeof(INT)
#define ZORDER_SIZE                  sizeof(INT) + sizeof(VPP_ZORDER_CTRL)
#define GFX_LUT_SIZE(size)           sizeof(INT)*size + sizeof(INT)*3
#define SCL_CUSTCOEFFS_SIZE          sizeof(UINT32)*2 + 33*12*sizeof(UINT16)
...
#define HDMI_AUXPKT_SIZE             sizeof(VPP_HDMI_PKT) + 2*sizeof(INT)
#define WSSDATA_SIZE                 sizeof(INT) + sizeof(VPP_WSS_DATA)
#define CGMSDATA_SIZE                sizeof(INT) + sizeof(VPP_CGMS_DATA)
#define VPP_DVINITFRAMEDUMP_SIZE     ((sizeof(VPP_DV_FRAME_DUMP)/4) + 2) * (sizeof(UINT32))
#define EARC_SET_CAPS_SIZE(size)     size + 2*sizeof(INT)

typedef enum VPP_BE_HDMITX_SINK_ISSUES_BL_T {
    SINK_PLL_59_94_FRAC_MODE_XML = 0,
    SINK_PLL_59_94_FRAC_MODE_DYN = 1,
    SINK_DUMMY_MODE_ID = 2,
    SINK_BL_ISSUE_MAX_ID = 3
} VPP_BE_HDMITX_SINK_ISSUES_BL;
...
/***************************************
 * FUNCTION: Load mipi configuration
 * INPUT: VPP_MIPI_LOAD_CONFIG
 * RETURN: NONE
 **************************************/
