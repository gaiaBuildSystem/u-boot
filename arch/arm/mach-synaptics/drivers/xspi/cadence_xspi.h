...
#define CDNS_XSPI_PHY_DATASLICE_REG_BASE			0x2000
#define CDNS_XSPI_PHY_DATASLICE_RFILE_PHY_DQ_TIMING		(CDNS_XSPI_PHY_DATASLICE_REG_BASE + 0x0000)
#define CDNS_XSPI_PHY_DATASLICE_RFILE_PHY_DQS_TIMING		(CDNS_XSPI_PHY_DATASLICE_REG_BASE + 0x0004)
#define CDNS_XSPI_PHY_DATASLICE_RFILE_PHY_GATE_LPBK_CTRL	(CDNS_XSPI_PHY_DATASLICE_REG_BASE + 0x0008)
#define CDNS_XSPI_PHY_DATASLICE_RFILE_PHY_DLL_MASTER_CTRL	(CDNS_XSPI_PHY_DATASLICE_REG_BASE + 0x000c)
#define CDNS_XSPI_PHY_DATASLICE_RFILE_PHY_DLL_SLAVE_CTRL	(CDNS_XSPI_PHY_DATASLICE_REG_BASE + 0x0010)
#define CDNS_XSPI_DATASLICE_RFILE_PHY_DLL_OBS_REG_0		(CDNS_XSPI_PHY_DATASLICE_REG_BASE + 0x001c)
#define CDNS_XSPI_PHY_CTB_RFILE_PHY_CTRL			(CDNS_XSPI_PHY_DATASLICE_REG_BASE + 0x0080)
#define CDNS_XSPI_PHY_CTB_RFILE_PHY_TSEL			(CDNS_XSPI_PHY_DATASLICE_REG_BASE + 0x0084)
...
static inline u32 cdns_xspi_readl(struct cdns_xspi_priv *priv, int reg)
{
	return readl(priv->regbase + reg);
}

static inline void cdns_xspi_writel(struct cdns_xspi_priv *priv, u32 val, int reg)
{
	return writel(val, priv->regbase + reg);
}
